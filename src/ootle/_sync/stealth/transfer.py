"""``StealthTransfer`` — confidential-transfer builder.
...
from ootle._sync.stealth._builder_prepare import prepare_stealth_transfer
...
class StealthTransfer:
    ...
    def __init__(self, client: OotleClient, resource: ResourceAddress) -> None:
        self._client = client
    ...
    def prepare(self) -> StealthTransferSpec:
        """Generate the transfer statement, emit instructions, resolve inputs."""
        return prepare_stealth_transfer(
            client=self._client,
