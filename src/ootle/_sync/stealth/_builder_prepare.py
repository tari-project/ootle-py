"""Terminal :meth:`StealthTransfer.prepare` flow.
...
def prepare_stealth_transfer(
    *,
    ...
    outputs_result = _call_outputs_statement(client, state)
...
def _signer_account(client: OotleClient) -> ComponentAddress:
